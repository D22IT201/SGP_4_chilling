	...
	if( !function_exists('gdlr_regiser_use_script') ){
		function gdlr_regiser_use_script($array){	
			...
			if( is_search() || is_archive() || 
				...
				$array['style']['hotelmaster-flexslider'] = GDLR_PATH . '/plugins/flexslider/flexslider.css';
				$array['script']['hotelmaster-flexslider'] = GDLR_PATH . '/plugins/flexslider/jquery.flexslider.js';
			}
