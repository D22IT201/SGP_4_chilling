...
<?php
    ...
    if(isset($_SESSION['user']))
    {
        ...
        echo "<h1> Your Total Amount Is  <font color='#FF5E0E'> $tot </font> </h1>";
...
?>
    ...
    <form action="final_book.php">
		<div class="text-left"><br>
			<button class="btn btn-primary solid blank" type="submit">Do Payment!</button> 
        </div>
	</form>
