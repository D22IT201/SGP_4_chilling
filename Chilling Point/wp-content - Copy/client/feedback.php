...
<?php include('header.php')?>
	...
	<section id="main-container">
		<div class="container">
			...
			<div class="row">
	    		<div class="col-md-12">
	    			<form id="contact-form" action="feedbackfire.php" method="post" role="form">
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label>Name</label>
								<input class="form-control" name="txtfn" id="name" placeholder="" type="text" required>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label>Email</label>
									<input class="form-control" name="txtem" id="email" 
							...
							<div class="col-md-4">
								<div class="form-group">
									<label>Contact</label>
									<input class="form-control" name="txtcn" id="subject" 
						...
						<div class="form-group">
							...
							<textarea class="form-control" name="txtfeed" id="message" placeholder="" rows="10" required></textarea>
						</div>
						<div class="text-center"><br>
							<button class="btn btn-primary solid blank" type="submit">Feedback!</button> 
						</div>
					</form>
	    		</div>
	    		<!-- <div class="col-md-5">
