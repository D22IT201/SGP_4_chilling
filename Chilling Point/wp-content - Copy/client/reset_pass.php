	    			...
	    			<form id="contact-form" action="#" method="post" role="form">
						<div >
							<div class="form-group">
								...
								<input class="form-control" name="txtp1" placeholder="" type="password" required>
								</div>
							</div>
							<!-- <div class="col-md-4">
								<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="password" class="form-control" name="txtp2" placeholder="" required>
							<!-- <textarea class="form-control" name="message" id="message" placeholder="" rows="10" required></textarea> -->
						</div>
						<div class="text-center"><br>
							<button class="btn btn-primary solid blank" type="submit">Reset !</button> 
						</div>
					</form>
	    		</div>
	    		<div class="col-md-5">
